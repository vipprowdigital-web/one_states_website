...
export default function BlogDetailPage() {
  ...
  return (
    <main className="min-h-screen bg-white font-[Raleway] text-[#232627]">
      {/* ── Hero / Header ── */}
      <section
        className="border-b border-[#ebebeb] px-6 py-16 md:py-24"
      ...
      >
        <div className="mx-auto max-w-4xl">
          ...
          {blog.category && (
            <p
              className="mt-6 mb-4 inline-flex items-center gap-3 text-xs font-bold uppercase tracking-[0.28em]"
          ...
          >
            ...
            >
              ...
              {blog.createdBy?.name && (
                <span
                  style={{ fontSize: 13, fontWeight: 700, color: "#232627" }}
                >
                  {blog.createdBy.name}
                </span>
              )}
