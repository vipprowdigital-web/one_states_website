...
const LEFT = [
  {
    ...
    title: "22+ Years of Leadership Experience ",
    desc: "With 22+ years of leadership experience across hospitality, FMCG and business expansion, we bring strong expertise in strategic growth, partnerships and market development. .",
  },
  {
    icon: (
      <svg width="28" height="28" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
    ...
    <>
      ...
      <section className="wcu-wrap relative overflow-hidden border-t border-[#ebebeb] bg-white px-6 md:py-25 py-10">
        ...
        <div className="relative mb-16 text-left md:text-center">
          ...
          <Reveal delay={150}>
            <p className="mt-5 max-w-[600px] text-base font-medium leading-8 text-[var(--primary)]/65 md:mx-auto md:text-lg">
              From concept to culture — we bring unmatched expertise, deep hospitality
              insight, and a genuine commitment to your growth.
            </p>
          </Reveal>
        </div>
          ...
          <div className="wcu-center-col relative">
            <Reveal delay={60}>
              <div className="relative aspect-[3/4] overflow-hidden rounded-[20px] bg-[#1a1a1a] shadow-[0_32px_80px_rgba(0,0,0,.18)]">
                ...
                <div className="absolute right-[-14px] top-5 z-[3] rounded-xl bg-[#ee7124] px-[18px] py-2.5 text-white shadow-[0_8px_24px_rgba(238,113,36,.35)]">
                  <p className="m-0 text-xl font-extrabold leading-none">
                    15+
                  </p>
...
function FeatureCard({ icon, title, desc, align }) {
  ...
  return (
    ...
    >
      <div
        className={`wcu-icon flex h-[52px] w-[52px] items-center justify-center rounded-[14px] bg-[rgba(238,113,36,.09)] text-[#ee7124] ${
